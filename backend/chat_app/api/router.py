...
urlpatterns = [
    ...
    path("chatsession/<int:sessionid>/", ChatSessionView.as_view(), name="chatsession"),
    path("chatsession/<int:sessionid>/audio-playback/", SessionAudioPlaybackView.as_view(), name="session_audio_playback"),
